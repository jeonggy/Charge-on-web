                    ...
                    <CTabPane>
                      <CCardBody>
                        ...
                        <CDataTable
                          ...
                          clickableRows
                          scopedSlots={{
                            충전기: (item, index) => <td>{item.name}</td>,
                            주차장: (item, index) => <td>{item.role}</td>,
                ...
                <CCardBody>
                  ...
                  <CRow>
                    <CCol xs="12">
                      ...
                      <CCol xs="12">
                        <tr style={{ color: "#989898", fontSize: "14px" }}>
                          내용
                        </tr>
                        <tr class="text-left" style={{ fontSize: "14px" }}>
                          {this.state.selectedItem.name}
                        </tr>
                      </CCol>
                      <br />
                      <CCol xs="12">
                        ...
                        <tr class="text-left" style={{ fontSize: "14px" }}>
                          <img
                            src={this.state.selectedItem.name}
                            width="400px"
                            height="400px"
                          />
                          <br />
