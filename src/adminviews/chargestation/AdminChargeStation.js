...
class AdminChargeStation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      index: 0,
  ...
  stationlistAddBtnClicked = () => {
    document.location.href = "#/adminstationchargelist";
  };
        ...
        <CRow>
            ...
            <CCard>
              <CRow>
                <h2 style={{ padding: "12px 0px 8px 32px" }}>
                  ...
                  <span style={{ color: "#318CFB" }}>논현동아파트A입구</span>
                </h2>
                <CCol className="text-right">
                  <CButton
                    active
                    style={{ margin: "12px 24px 0px 0px" }}
                    color="light"
                    aria-pressed="true"
                    ...
                    <CCol xs="12">
                      ...
                      <CCol className="text-center">
                        <CButton
                          ...
                          onClick={() => this.stationlistAddBtnClicked()}
                        >
                          충전기 리스트
                        </CButton>
                      </CCol>
          ...
          >
            ...
            <CModalFooter>
              <CButton
                color="light"
                onClick={() => this.setState({ edstationAddModalOpen: false })}
              >
                취소
              </CButton>
              <CButton
...
export default AdminChargeStation;
